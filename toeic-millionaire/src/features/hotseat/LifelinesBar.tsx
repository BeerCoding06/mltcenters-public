  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "flex gap-3",
          vertical ? "flex-col items-center" : "flex-row flex-wrap justify-center",
        )}
      >
        {items.map((item) => (
          <button
          ...
          >
            <span
              className={cn(
                "relative flex size-[3.25rem] items-center justify-center rounded-[3px] border bg-black sm:size-14",
            ...
            {!vertical ? (
              <span className="max-w-[4.5rem] text-center text-[9px] leading-tight text-[#c9a227]">
                {item.label}
              </span>
            ) : null}
          </button>
