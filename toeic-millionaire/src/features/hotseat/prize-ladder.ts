/** 15-step prize ladder (quiz-show style). Safe havens at steps 5 and 10. */
export const PRIZE_LADDER = [
  ...
  { step: 15, amount: 1_000_000, label: "฿1,000,000" },
] as const;
...
/** Guaranteed take-home after answering `answeredCount` correctly (0 = nothing yet). */
