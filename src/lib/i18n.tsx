...
export const translations = {
  nav: {
    ...
    quizMenu: { en: "AI / Vocab", th: "AI/คำศัพท์" },
  ...
  vocabPage: {
    layout: {
      badge: { en: "AI Tutor", th: "AI ติวเตอร์" },
      title: { en: "Vocabulary Learning", th: "เรียนศัพท์" },
    },
    onboarding: {
      title: { en: "Set your learning goal", th: "ตั้งเป้าหมายการเรียน" },
      subtitle: {
        en: "Pick what you want to focus on — we'll start at Starter level.",
        th: "เลือกเป้าหมายที่อยากเน้น — เริ่มที่ระดับ Starter",
      },
      goalLabel: { en: "Your goal", th: "เป้าหมายของคุณ" },
      goals: {
        general: { en: "General English", th: "ภาษาอังกฤษทั่วไป" },
        toeic: { en: "TOEIC prep", th: "เตรียมสอบ TOEIC" },
        travel: { en: "Travel", th: "ท่องเที่ยว" },
        business: { en: "Business", th: "ธุรกิจ" },
      },
      levelLabel: { en: "Starting level", th: "ระดับเริ่มต้น" },
      levelStarter: { en: "Starter", th: "Starter" },
      startButton: { en: "Start learning", th: "เริ่มเรียน" },
      saving: { en: "Saving…", th: "กำลังบันทึก…" },
    },
    dashboard: {
      title: { en: "Today's progress", th: "ความคืบหน้าวันนี้" },
      subtitle: {
        en: "Learn new words, review what you know, and keep your streak.",
        th: "เรียนคำใหม่ ทบทวนคำเก่า และรักษาสตรีค",
      },
      streak: { en: "Streak", th: "สตรีค" },
      xp: { en: "XP", th: "XP" },
      wordsLearned: { en: "Words learned", th: "คำที่เรียนแล้ว" },
      accuracy: { en: "Accuracy (7d)", th: "ความแม่นยำ (7 วัน)" },
      todayTitle: { en: "Today's plan", th: "แผนวันนี้" },
      learnRemaining: { en: "New words left", th: "คำใหม่ที่เหลือ" },
      reviewDue: { en: "Review due", th: "ต้องทบทวน" },
      weakTitle: { en: "Needs practice", th: "ควรฝึกเพิ่ม" },
      strongTitle: { en: "Strong words", th: "คำที่จำได้ดี" },
      noWeak: { en: "No weak words yet — keep learning!", th: "ยังไม่มีคำอ่อน — เรียนต่อไป!" },
      noStrong: { en: "Build your strong list by reviewing.", th: "ทบทวนเพื่อสร้างรายการคำแข็ง" },
      coachTip: { en: "Coach tip", th: "คำแนะนำจากโค้ช" },
      ctaLearn: { en: "Learn new words", th: "เรียนคำใหม่" },
      ctaReview: { en: "Smart review", th: "ทบทวนอัจฉริยะ" },
