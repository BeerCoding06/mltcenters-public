...
export default function VocabLearnPage() {
  ...
  if (dashboard.today.learnRemaining <= 0) {
    return (
      <div className="container mx-auto px-4 py-16 max-w-md text-center space-y-4">
        <h2 className="text-xl font-bold heading-gradient">{t.vocabPage.learn.emptyTitle[lang]}</h2>
        <p className="text-muted-foreground">{t.vocabPage.learn.emptyBody[lang]}</p>
        <Link
          to="/vocab/review"
  ...
  return <VocabSessionFlow mode="learn" showCard />;
}
